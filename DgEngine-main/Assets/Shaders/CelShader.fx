// Description : shader that uses cel shading effect on objects
...
float4 PS(VS_OUTPUT input) : SV_Target
{
    ...
    float4 diffuse = lightDiffuse * d * materialDiffuse;
    ...
    float4 specular = lightSpecular * s * materialSpecular;
