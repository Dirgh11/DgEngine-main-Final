...
void DgEngine::Graphics::ModelIO::SaveAnimation(std::filesystem::path filePath, const Model& model)
{
...
void DgEngine::Graphics::ModelIO::LoadAnimation(std::filesystem::path filePath, Model& model)
{
	filePath.replace_extension("animset");
