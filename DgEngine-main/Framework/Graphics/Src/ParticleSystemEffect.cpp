...
void DgEngine::Graphics::ParticleSystemEffect::Render(const Transform& transform, const Color& color)
{
...
void DgEngine::Graphics::ParticleSystemEffect::SetTextureId(TextureId id)
{
	mTextureId = id;
}